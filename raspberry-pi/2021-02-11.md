...
- [2021-02-11](#2021-02-11)
  ...
  - [진짜로 kubernetes 설치해보기! 에 앞서 분석...](#진짜로-kubernetes-설치해보기-에-앞서-분석)
...
그리고 리부트한 다음에 다시 Port 번호를 통해서 ssh로 접속해서 확인하면 된다.
...
## 진짜로 kubernetes 설치해보기! 에 앞서 분석...

우선 [라즈베리파이4 에 싱글노드(1대) 쿠버네티스 설치 하기](https://lance.tistory.com/5?category=966467)을 메인으로 참고해서 진행해보겠다.

그런데 k3s, MicroK8s 등 경량화된 k8s가 여러 개 있는 것 같다.

우선 그 [차이점](./2021-02-11-k8s.md)부터 알아보자.
